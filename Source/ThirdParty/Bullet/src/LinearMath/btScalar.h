...
// Dry - enable BT_USE_SSE for MinGW
...
// Dry - allow to disable SSE/NEON and let Linux, MinGW, & Android platforms in besides Apple
...
#if defined(_WIN32) && !defined(__MINGW32__)	// Dry - enable BT_USE_SSE for MinGW
