...
// Modified by Yao Wei Tjong, Skrylar and Ramil Sattarov for Dry
...
// Dry: Added description of how to identify LCC and MCST lcc compilers
...
// Dry: Added identifier for definition e2k architecture
...
// MSVC2015 can now use CLang too, but it shouldn't go in here
	...
	// Linux
		...
		#define COMPLEX_RETURN_MASK (asOBJ_APP_CLASS_DESTRUCTOR | asOBJ_APP_CLASS_COPY_CONSTRUCTOR | asOBJ_APP_ARRAY)
            ...
            // Dry - Add support for aarch64-linux-gnu
			...
			#define AS_MAX_PORTABILITY
		// Dry - Add support for e2k-linux-gnu
	...
	// Android
		...
		#define COMPLEX_RETURN_MASK (asOBJ_APP_CLASS_DESTRUCTOR | asOBJ_APP_CLASS_COPY_CONSTRUCTOR | asOBJ_APP_ARRAY)
			...
			#define AS_X86
			#undef AS_NO_THISCALL_FUNCTOR_METHOD
// Dry - Add support for Android Intel x86_64 and Android ARM 64bit
