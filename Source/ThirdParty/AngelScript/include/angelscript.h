...
// Modified by Lasse Oorni, Nathanial Lydick, Yao Wei Tjong and Ramil Sattarov for Dry
...
// Dry: Define AS_MAX_PORTABILITY for Web and 64-bit ARM / MCST Elbrus 2000 platforms
...
{
// Dry - Clang compiler built with old GCC's libstdc++ suffers the same pre-standard templates problem as old GCC compiler
...
// Dry: Include the wrapper macros file but only after they have been defined above
// This causes a large number of warnings, which could possibly be prevented with further
// changes to the library or the Dry Angelscript code
