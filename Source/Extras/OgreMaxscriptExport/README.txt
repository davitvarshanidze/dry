...
* Select initDryTools.ms from Startup folder and press OK.

Add button
* Select Customize -> Customize User Interface menu item.
* Goto Toolbar tab.
* From Category list select Dry tools (Scroll down to see it).
* Drag Dry Exporter item to toolbar in 3dsmax to create button.
* Enjoy!
