...
-- cin - 2013
--
-- Macroscript for the Dry Toolbar 1.0
--
...
macroScript showOgreExportTools
	category:"Dry Tools"
	internalCategory:"Dry Tools"
	buttonText:"Dry Exporter"
	tooltip:"Dry Exporter"
	Icon:#("Maintoolbar",49)
(
	-- create a floater
	OgreExportFloater = newRolloutFloater "Dry Ogre Exporter - 1.00" 280 800 ;
	...
	(
		label label11 "For use with the Dry graphics engine." align:#center;
