...
macro(_test_compiler_hidden_visibility)
  ...
  if(NOT GCC_TOO_OLD
    ...
    # Dry - set the flags in a variable before testing
...
macro(_DO_SET_MACRO_VALUES TARGET_LIBRARY)
  ...
  # Dry: always generate header file regardless of target type
    if(WIN32 OR CYGWIN)
...
macro(_DO_GENERATE_EXPORT_HEADER TARGET_LIBRARY)
  ...
  # Dry: Our revised version does not depend on the target to be added first, so always derive the variable value from target name instead
...
# Dry: revise to pass the library type by argument so that it does not depend on the target to be added first
