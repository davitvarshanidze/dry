...
void CreateScene()
{
    ...
    planeNode.scale = Vector3(400.0f, 1.0f, 400.0f);
    StaticModel@ planeObject = planeNode.CreateComponent("StaticModel");
    planeObject.model = cache.GetResource("Model", "Models/Plane.mdl");
    planeObject.material = cache.GetResource("Material", "Materials/GrassRockTiled.xml");
    ...
    cameraNode.position = Vector3(0.0f, 3.0f, -23.0f);
}
