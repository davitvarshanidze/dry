...
void CreateScene()
{
    ...
    light.shadowFadeDistance = 750.0f;
    light.shadowBias = BiasParameters(0.00025f, 0.5f);
    light.shadowCascade = CascadeParameters(10.0f, 100.0f, 300.0f, 600.0f, 0.8f);
    light.specularIntensity = 0.7f;
    ...
    for (uint i = 0; i < NUM_OBJECTS; ++i)
    {
        ...
        float scale = Max(0.1f, RandomNormal(5.0f, 2.3f));

        position.y = terrain.GetHeight(position) + scale * 0.5f;
