...
void CreateUI()
{
    ...
    graphics.windowIcon = cache.GetResource("Image", "Textures/DryIcon.png");
...
void UpdateWindowTitle()
{
    ...
    if (sceneModified)
        sceneName += "*";
    graphics.windowTitle = "Dry editor - " + sceneName;
}
...
XMLFile@ GetEditorUIXMLFile(const String&in fileName)
{
    ...
    // to an outdated Dry installation
