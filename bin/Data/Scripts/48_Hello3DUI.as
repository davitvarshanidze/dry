...
void Start()
{
    ...
    CreateInstructions("Press Tab to toggles between rendering on screen or cube\n"
...
void CreateDraggableEmblem()
{
    ...
    draggableEmblem.texture = cache.GetResource("Texture2D", "Textures/DryDecalAlpha.png"); // Set texture
    draggableEmblem.blendMode = BLEND_ALPHA;
...
void Init3DUI()
{
    ...
    component.material.SetTechnique(0, cache.GetResource("Technique", "Techniques/DiffUnlitAlpha.xml"));
