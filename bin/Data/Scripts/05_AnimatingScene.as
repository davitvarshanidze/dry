...
void CreateScene()
{
    ...
    zone.ambientColor = Color(0.1f, 0.05f, 0.4f);
    zone.fogColor = Color(0.125f, 0.0f, 0.15f);
    zone.fogStart = 9.0f;
    zone.fogEnd = 42.0f;
    ...
    for (uint i = 0; i < NUM_OBJECTS; ++i)
    {
        ...
        boxNode.position = Vector3(Random(100.0f) - 50.0f, Random(100.0f) - 50.0f, Random(100.0f) - 50.0f);
        ...
        ValueAnimation@ pulse = ValueAnimation();
        pulse.interpolationMethod = IM_SINUSOIDAL;
    ...
    light.color = Color(0.7f, 1.0f, 0.4f);
}
