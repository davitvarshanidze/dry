...
void CreateScene()
{
    ...
    lightNode.position = Vector3::UP * 10.0f;
    ...
    // Use sinusoidal interpolation method
    positionAnimation.interpolationMethod = IM_SINUSOIDAL;
    // Set spline tension
    positionAnimation.SetKeyFrame(0.0f, Variant(Quaternion( 30.0f, 0.0f, 0.0f)));
    positionAnimation.SetKeyFrame(2.0f, Variant(Quaternion(150.0f, 0.0f, 0.0f)));
    positionAnimation.SetKeyFrame(4.0f, Variant(Quaternion( 30.0f, 0.0f, 0.0f)));
    lightNode.SetAttributeAnimation("Rotation", positionAnimation);
    ...
    cameraNode.position = Vector3(0.0f, 5.0f, -50.0f);
}
